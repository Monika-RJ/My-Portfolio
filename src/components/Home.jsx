        ...
        <div className="max-w-[85%] mx-auto font-inter grid grid-cols-1 md:grid-cols-2 gap-8 items-center min-h-screen">
          ...
          <div className="order-2 lg:order-1 flex flex-col items-center md:items-start justify-start space-y-5 text-center md:text-left">
            <h1 className="text-3xl md:text-5xl font-bold">
              I’m <span className="text-[#ca03fc]">Monika Jothi</span>
            </h1>
            <h2 className="text-2xl md:text-3xl font-bold flex gap-2">
              <span className="text-[#ca03fc]">I’m a</span>
              <Typewriter
                options={{
                  strings: [
            ...
            <p className="text-lg md:text-xl text-gray-700 font-medium">
              ...
              building scalable web applications. Enthusiastic about AI,
              Machine Learning, and Data Analysis, I enjoy solving real-world
              problems and sharing knowledge through tutoring and content
              creation.
            </p>
            ...
            {/* Button */}
            <div className="bg-[#ca03fc] px-5 py-2 rounded-2xl font-bold">
              <a
